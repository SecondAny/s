...
function addEventos() {
    ...
    btnFinal.addEventListener('click', (event) => {
        alert('Vida... eu te amo infinitamente, eu não sei o que faria sem você... tenho tanto medo de te perder, me desculpa... EU TE AMO INFINITAMENTE.... eu preciso de você...')
    })
